...
public class TopicExchangeConfig {
    ...
    @Bean
    Queue createTopicQueue1(){return new Queue(topicQueue1,true,false,false);}
    @Bean
    Queue createTopicQueue2(){return new Queue(topicQueue2,true,false,false);}
    @Bean
    Queue createTopicQueue3(){return new Queue(topicQueue3,true,false,false);}
    ...
    Binding createTopicBinding1(){
        return BindingBuilder.bind(createTopicQueue1()).to(createTopicExchange()).with(binding2);
    }
    @Bean
